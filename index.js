...
const questions = [
    ...
    {
        name: "q6",
        message: "What is the difference between '==' and '===' operators in JavaScript?",
        type: "list",
        choices: [
    ...
    },
    {
        ...
        answer: "A JavaScript mechanism where variables and function declarations are moved to the top of their containing scope",
    },
];
let score = 0;
